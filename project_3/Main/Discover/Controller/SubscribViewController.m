...
static NSString* const WaterfallCellIdentifier = @"WaterfallCell_3";
static NSString* const WaterfallHeaderIdentifier = @"WaterfallHeader_3";
@interface SubscribViewController ()<FRGWaterfallCollectionViewDelegate, UICollectionViewDelegate,UICollectionViewDataSource>{
    UIView *alphaView;
    UILabel *themeLabel;
...
- (void)viewDidLoad {
    ...
    [DataService getSubscribRequestWithNextStart:self.condition Success:^(NSArray *result, NSString *start) {
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView
    ...
    [collectionView dequeueReusableSupplementaryViewOfKind:kind
                                       withReuseIdentifier:@"WaterfallHeader_3"
                                              forIndexPath:indexPath];
...
- (void)_setBackBarButton{
    ...
    themeLabel.textColor = [UIColor clearColor];
    ...
    [rightButton setTitle: @"订阅" forState:UIControlStateNormal];
